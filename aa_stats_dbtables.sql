...
CREATE UNIQUE INDEX CLAIMDROPKEY_I01 ON CLAIMDROPKEY (network, seq);
CREATE INDEX CLAIMDROPKEY_I02 ON CLAIMDROPKEY (network, block_time);
CREATE INDEX CLAIMDROPKEY_I03 ON CLAIMDROPKEY (network, drop_id, block_time);
CREATE INDEX CLAIMDROPKEY_I04 ON CLAIMDROPKEY (network, claimer, block_time);
CREATE INDEX CLAIMDROPKEY_I05 ON CLAIMDROPKEY (trx_id(16));
CREATE INDEX CLAIMDROPKEY_I06 ON CLAIMDROPKEY (network, country, block_time);
